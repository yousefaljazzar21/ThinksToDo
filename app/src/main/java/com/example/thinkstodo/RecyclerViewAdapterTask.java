...
public class RecyclerViewAdapterTask extends RecyclerView.Adapter<RecyclerViewAdapterTask.ViewHolder> {
    ...
    public RecyclerViewAdapterTask(Context context, List<TaskClass> taskList) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int position) {
        ...
        final TaskClass taskEntity = taskList.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, Context ctx) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    TaskClass task = taskList.get(position);
        ...
        public void setData(TaskClass task) {
